export default {
    ...
    'menu.oils': '油品',
    'menu.oils.stream': '油品订单流水',
    'menu.oils.index': '统计',
    'menu.manage': '系统设置',
    'menu.manage.user': '用户管理',
    'menu.store': '便利店',
    'menu.store.store': '便利店',
    'menu.store.running': '便利店-流水订单',
    'menu.store.storemanage': '便利店-商品管理',
    'menu.store.before': '前台',
    'menu.store.before.form': '前台 油品交款对账报表',
    ...
    'menu.form.stepform.stepform': 'qwssa',
    'menu.list': '列表页',
    ...
    'app.analysis.today': '当天',
    'app.analysis.toweek': '周',
    'app.analysis.tomonth': '月',
    'app.analysis.toyear': '年',
